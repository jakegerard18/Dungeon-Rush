...
export default class Preloader extends Phaser.Scene {
	...
	preload() {
		this.load.image('tiles', 'textures/tiles_dungeon_v1_extruded.png');
		...
		this.load.tilemapTiledJSON('room_1_json', 'textures/room_1.json');
		this.load.tilemapTiledJSON('room_2_json', 'textures/room_2.json');
		this.load.tilemapTiledJSON('room_3_json', 'textures/room_3.json');
		this.load.tilemapTiledJSON('room_4_json', 'textures/room_4.json');
