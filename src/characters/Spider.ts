...
export default class Spider extends Phaser.Physics.Arcade.Sprite
{
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, texture: string, frame?: string | number)
    {
        ...
        this.anims.play('spider-run-left', true);
            ...
            case Current_State.UP:
                {
                    ...
                    this.performDamage('spider-hit-up');
                    break;
                }
            ...
            case Current_State.DOWN:
                {
                    this.currentState = Current_State.DAMAGED;
                    this.setVelocity(dir.x, dir.y);
                    this.performDamage('spider-hit-down');
                    break;
                }
            ...
            case Current_State.LEFT:
                {
                    this.currentState = Current_State.DAMAGED;
                    this.setVelocity(dir.x, dir.y);
                    this.performDamage('spider-hit-left');
                    break;
                }
            ...
            case Current_State.RIGHT:
                {
                    this.currentState = Current_State.DAMAGED;
                    this.setVelocity(dir.x, dir.y);
                    this.performDamage('spider-hit-right');
                    break;
                }
    ...
    preUpdate(t:number, dt:number)
    {
        ...
        switch(this.currentState){
            case Current_State.UP:
                ...
                this.anims.play('spider-run-up', true);
                break;

            case Current_State.DOWN:
                this.setVelocity(0, this.vel);
                this.anims.play('spider-run-down', true);
                break;
            ...
            case Current_State.RIGHT:
                this.setVelocity(this.vel, 0);
                this.anims.play('spider-run-right', true);
                break;

            case Current_State.ATTACKING_UP:
                this.setVelocity(0, -this.vel);
                this.anims.play('spider-attack-up', true);
                break;

            case Current_State.ATTACKING_DOWN:
                this.setVelocity(0, this.vel);
                this.anims.play('spider-attack-down', true);
                break;

            case Current_State.ATTACKING_LEFT:
                this.setVelocity(-this.vel, 0);
                this.anims.play('spider-attack-left', true);
                break;

            case Current_State.ATTACKING_RIGHT:
                this.setVelocity(this.vel, 0);
                this.anims.play('spider-attack-right', true);
                break;
        }
    }
}