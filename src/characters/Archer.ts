...
export default class Archer extends Phaser.Physics.Arcade.Sprite
{
    ...
    constructor(scene: Phaser.Scene, x: number, y: number, texture: string, frame?: string | number)
    {
        ...
        this.anims.play('archer-run-left', true);
            ...
            case Current_State.UP:
                {
                    ...
                    this.performDamage('archer-hit-up');
                    break;
                }
            ...
            case Current_State.DOWN:
                {
                    this.currentState = Current_State.DAMAGED;
                    this.setVelocity(dir.x, dir.y);
                    this.performDamage('archer-hit-down');
                    break;
                }
            ...
            case Current_State.LEFT:
                {
                    this.currentState = Current_State.DAMAGED;
                    this.setVelocity(dir.x, dir.y);
                    this.performDamage('archer-hit-left');
                    break;
                }
            ...
            case Current_State.RIGHT:
                {
                    this.currentState = Current_State.DAMAGED;
                    this.setVelocity(dir.x, dir.y);
                    this.performDamage('archer-hit-right');
                    break;
                }
    ...
    preUpdate(t:number, dt:number)
    {
        ...
        switch(this.currentState){
            case Current_State.UP:
                ...
                this.anims.play('archer-run-up', true);
                break;

            case Current_State.DOWN:
                this.setVelocity(0, this.vel);
                this.anims.play('archer-run-down', true);
                break;
            ...
            case Current_State.RIGHT:
                this.setVelocity(this.vel, 0);
                this.anims.play('archer-run-right', true);
                break;

            case Current_State.ATTACKING_UP:
                this.setVelocity(0, 0);
                this.anims.play('archer-attack-up', true);
                break;

            case Current_State.ATTACKING_DOWN:
                this.setVelocity(0, 0);
                this.anims.play('archer-attack-down', true);
                break;

            case Current_State.ATTACKING_LEFT:
                this.setVelocity(0, 0);
                this.anims.play('archer-attack-left', true);
                break;

            case Current_State.ATTACKING_RIGHT:
                this.setVelocity(0, 0);
                this.anims.play('archer-attack-right', true);
                break;
        }
    }
}